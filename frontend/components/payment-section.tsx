  ...
  return (
    <main className="min-h-screen bg-[#f6f8fb] p-5 text-[#17202a] sm:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><div className="text-sm font-semibold text-[#2557d6]">Payments</div><h1 className="mt-1 text-3xl font-semibold tracking-[-0.04em] sm:text-4xl">Money received</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-[#687485]">Record payments and keep invoices moving toward paid.</p></div><button className="btn-primary" onClick={openCreate}><Plus size={17}/> Record payment</button></div>

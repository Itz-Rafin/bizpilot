...
export default function InvoiceSection() {
  ...
  async function load() {
    try {
      ...
      const [invoiceData, customerData, workspace] = await Promise.all([api.invoices.list(), api.customers.list(), api.workspace.me()]);
